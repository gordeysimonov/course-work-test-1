...
// імплементувати бібліотеку UserDetails для встановлення цього користувача, як користувача реєстрації (логіну)
// реалізувати сет повноважень (authorities) (authority - окрема таблиця і зв'язок OneToMany) (у юзера одне повноваження - або звичайни користувач, або адміністратор)
